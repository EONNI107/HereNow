  ...
  return (
    <div className="flex flex-col items-center pt-2 mx-auto">
      <form onSubmit={handleClick}>
        ...
        />
        <button className="ml-1 border-[2px] px-[10px] py-[1px] rounded-lg hover:border-[#118DFF] hover:bg-blue0 hover:text-main">
          검색
        </button>
      </form>
      ...
      <div className="flex gap-2 flex-wrap justify-center">
        {originalData.map((item, index) => {
          ...
          return (
            <div
              key={index}
              className="flex border-[2px] rounded-2xl px-3 py-1 mb-1 gap-2 hover:border-[#118DFF] hover:bg-blue0 hover:text-main"
            >
              <li
