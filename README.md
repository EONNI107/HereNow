...
- [x] 사용자는 현재 위치, 전국 키워드와 또는 검색을 이용하여 정보(맛집, 관관지, 행사등)를 찾을 수 있어요<br />
- [x] 각 지역만의 정보(맛집, 관관지, 행사등)를 한눈에 확인할 수 있어요<br />
- [x] 피드를 통해 관련 로컬들의 맛집, 관관지, 행사등의 후기를 한눈에 볼 수 있어요<br />
- [x] 자신만의 피드를 작성하여 본인만의 이야기를 남길 수 있어요<br />
